...
import { selectRingsById } from "@farcaster/rings-next/state/rings/selectors";
import { selectUsersById } from "@farcaster/rings-next/state/users/selectors";
...
export const selectRings = createSelector(
    [selectRingsById, selectUsersById, selectStonesByRingId, selectRelationshipsBySource],
