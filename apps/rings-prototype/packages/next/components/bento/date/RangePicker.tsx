...
import {
  ...
  swapOnClick,
  useHeaderType,
} from '@tipster/next/components/bento/date/DatePicker';
import { Platform } from 'react-native'
import useDateAnimation from "@tipster/next/components/bento/date/useDateAnimation";
                    ...
                    return (
                      ...
                      >
                        <Button.Text
                          ...
                          $group-item-hover={{ color: d.selected ? '$gray6' : '$gray11' }}
                        >
                          {d.day}
                        </Button.Text>
                      </Button>
