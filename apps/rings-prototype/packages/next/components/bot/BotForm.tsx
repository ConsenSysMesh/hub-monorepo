...
import AutoCompleteList from "@tipster/next/components/autocomplete/AutoCompleteList";
import { Item } from "@tipster/next/components/autocomplete/AutoComplete";
import Clipboard from "@tipster/next/components/clipboard/Clipboard";
import BotDeleteAlert from "@tipster/next/components/bot/BotDeleteAlert";
import HorizontalRadio from "@tipster/next/components/bento/HorizontalRadio";
import HatsSelector from "@tipster/next/components/hats/HatsSelector";
import BotFormError from "@tipster/next/components/bot/BotFormError";
import Visibility from "@tipster/next/components/visibility/Visibility";
import { eligibilityEnums } from "@tipster/next/constants";
import schema from "@tipster/next/components/bot/formSchema";
